...
audios_folder = os.getenv("AUDIO_PATH") or '/mnt/c/Users/fabio/Flute Dataset/traditional-flute-dataset/audio'
# audios_folder = '/mnt/e/mdb-stem-synth-multi/audio'
annotations_folder = os.getenv("ANNOTATION_PATH") or '/mnt/c/Users/fabio/Flute Dataset/traditional-flute-dataset/annotations'
# annotations_folder = '/mnt/e/mdb-stem-synth-multi/annotation'

dataset_sampling_rate = 44100.
dataset_frame_size = 1024
dataset_hop_size = 441
    ...
    if options['prediction']:
        if os.getenv("WANDB_ENABLED") == "true":
            ...
            for audio_name in audios_list:
                ...
                print("Results:", rpa, substitution_error, miss_error, false_alarm, total_error)
